...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap = ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL,
                PREFIX_ADDRESS, PREFIX_COUNTRY, PREFIX_TAG);
        ...
        if (argMultimap.getValue(PREFIX_COUNTRY).isPresent()) {
            Optional<Country> countryOptional = ParserUtil.parseCountry(argMultimap.getValue(PREFIX_COUNTRY).get());
            if (countryOptional.isPresent()) {
                editPersonDescriptor.setCountry(countryOptional.get());
            }
        }
