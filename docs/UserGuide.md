...
* The channel field may be omitted, but if it is included, it **cannot be left blank**. You must specify one of the allowed channels: PHONE, EMAIL, SMS, WHATSAPP, or TELEGRAM.
...
* The language field is optional, but if omitted, defaults to English. It is **case-insensitive**.
