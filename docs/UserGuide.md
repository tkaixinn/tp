...
<!-- 🔹 Suggested addition -->
**Tip:** You can check your installed Java version by typing `java -version` in your terminal.  
If it shows a version below 17, please install a newer JDK before running Worldly.
